...
public class SalmaoCompraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_salmao_compra);
        ...
        ImageButton btnqtdLibras = (ImageButton) findViewById(R.id.librasqtdSalmao);
    ...
    public void clicando(View view){
        ...
        float valorTotal = (float) (quant * 49.90);

        int ObsRetirar = 0;
        int obsAdicionar = 0;

        CheckBox aze = findViewById(R.id.azeitonaCkk);
        CheckBox limao = findViewById(R.id.limaoCk);
        CheckBox alho = findViewById(R.id.alhocK);
        CheckBox tang = findViewById(R.id.tangerinaCk);
        CheckBox cogu = findViewById(R.id.cogumeloCk);
        ...
        bd.execSQL("INSERT INTO pedido(pratoOrBebida, obsRetirar, obsColocar,nomePrato, quant, valor) VALUES (1, " + ObsRetirar + ", " + obsAdicionar + ", 'Salmão Grelhado', " + quant + "," + valorTotal + ")");

        Toast.makeText(getApplicationContext(), "Prato inserido ao pedido", Toast.LENGTH_LONG).show();

        Pratos prato = new Pratos();
        prato.setNome("Salmão Grelhado");
        prato.setPreco(49.90);
